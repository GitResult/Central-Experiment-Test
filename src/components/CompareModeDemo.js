/**
 * CompareModeDemo Component
 *
 * Main comparison mode interface featuring interactive data tables with visual markers,
 * AI-powered chat panel, and draggable task management. Includes pie charts and radar
 * visualizations for data analysis.
 *
 * Features:
 * - Interactive data table with filtering
 * - Visual markers for highlighting records
 * - AI chat panel for automated task generation
 * - Drag-and-drop task organization
 * - Real-time data visualizations (pie charts, radar charts)
 * - Compare mode for side-by-side analysis
 *
 * @component
 * @returns {React.Component} CompareModeDemo component
 */
