 ...
 * Center droppable area for building pages
...
const CanvasElement = memo(function CanvasElement({ element, path, isSelected, onSelect, onUpdate, isPreviewMode }) {
  ...
  return (
    <div
      ...
      style={{
        outline: !isPreviewMode && isSelected ? `2px solid ${theme.colors.primary}` : 'none',
        outlineOffset: '2px',
...
const DropZone = memo(function DropZone({ zoneId, rowIndex, columnIndex }) {
  ...
  return (
    <div
      ...
      style={{
        borderColor: isOver ? theme.colors.primary : theme.colors.border.default,
        backgroundColor: isOver ? `${theme.colors.primary}10` : 'transparent',
        minHeight: '120px'
      }}
    >
      <div
    ...
    >
      ...
      <div className="max-w-4xl mx-auto mb-6">
        {isPreviewMode ? (
          ...
          <input
            ...
            onChange={(e) => {
              useEditorStore.getState().updatePageMetadata({ name: e.target.value });
            }}
      ...
      <div
        ...
        style={{
          ...
          border: isPreviewMode ? 'none' : `1px solid ${theme.colors.border.default}`,
          minHeight: '600px',
